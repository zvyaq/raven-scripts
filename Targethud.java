...
void drawVeryOldAstolfo(Entity entity){
      ...
      render.text("Ping: " + util.color( "&8" + Integer.toString(entity.getNetworkPlayer() != null ? entity.getNetworkPlayer().getPing() : 0)), 33 + adjustedX, 6.5f + 26 + adjustedY, 1, 0xFFFFFFFF, true);
      //gl.scissor(true);
